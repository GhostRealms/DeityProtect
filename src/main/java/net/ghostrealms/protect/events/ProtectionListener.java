package net.ghostrealms.protect.events;
...
import net.ghostrealms.protect.DeityProtectLangHelper;
import net.ghostrealms.protect.api.DeityChunk;
...
public class ProtectionListener extends DeityListener {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        DeityChunk
            dChunk = ProtectionManager
            .getChunk(player.getWorld().getName(), chunk.getX(), chunk.getZ());
        if (dChunk == null) { return; }
    ...
    private boolean verifyBlockMove(Block block, BlockFace direction) {
        ...
        if (chunkFrom == null || chunkTo == null) { return false; }
